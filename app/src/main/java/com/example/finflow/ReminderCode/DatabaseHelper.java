...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long insertData(String item, String date, String time) {
    ...
    public ArrayList<ReminderDataModel> getAllData() {
        ArrayList<ReminderDataModel> arrayList = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            ReminderDataModel dataModel = new ReminderDataModel(title, date, time);
