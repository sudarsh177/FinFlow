...
public class ItemAdapter extends BaseAdapter {
    ...
    private ArrayList<ReminderDataModel> arrayList;

    public ItemAdapter(Context context, ArrayList<ReminderDataModel> arrayList) {
        super();
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        ReminderDataModel dataModel = arrayList.get(position);
